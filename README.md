# Django-test-project-DRF
Это тестовый проект, который иллюстрирует мою работу с Django Rest Framework в фреймворке Django.
...
# Django-test-project-DRF
This is a test project that illustrates my work with Django Rest Framework in the Django framework.
